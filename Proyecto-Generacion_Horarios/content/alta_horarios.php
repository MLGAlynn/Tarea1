...
<center><h4> REGISTRO DE HORARIOS </h4></center>
<?php include ("database.php");
$docente = new Database();
if (isset($_POST) && !empty($_POST)){
    $tHorario = $docente->sanitize($_POST['tGradoAcademico']);
    $tTurno= $docente->sanitize($_POST['tNombreDocente']);
    ...
    $res = $docente->altadocentes($tGradoAcademico,$tNombreDocente,$tApellidoPaterno,$tApellidoMaterno,$tCorreoElectronico,$eTelefono);
    if ($res){
